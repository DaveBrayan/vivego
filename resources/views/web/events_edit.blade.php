                ...
                <div class="step-content-panel" id="stepPanel2">
                    <div class="settings-card-box">
                        ...
                        <form class="admin-modal-form" novalidate onsubmit="event.preventDefault(); goToStep(3);">
                            ...
                            <div style="margin-top: 1.75rem; margin-bottom: 1.75rem; background: rgba(255, 255, 255, 0.02); border: 1.5px dashed rgba(255, 255, 255, 0.18); border-radius: 18px; padding: 1.5rem;">
                                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1rem;">
                                    <div style="display: flex; align-items: center; gap: 0.65rem;">
                                ...
                                <input type="hidden" id="reference_image" value="{{ $eventData['reference_image'] ?? '' }}">
                                ...
                                <div id="referencePlaceholderBox" style="border: 1.5px dashed rgba(255, 255, 255, 0.15); background: rgba(15, 23, 42, 0.5); border-radius: 14px; padding: 2rem 1.5rem; text-align: center; cursor: pointer; transition: all 0.2s; display: {{ !empty($eventData['reference_image']) ? 'none' : 'block' }};" onclick="openMediaManager('reference_image');">
                                ...
                                <div id="referencePreviewContainer" style="display: {{ !empty($eventData['reference_image']) ? 'block' : 'none' }}; position: relative; border-radius: 14px; overflow: hidden; border: 1.5px solid rgba(255, 255, 255, 0.2); background: #0B0F19; text-align: center; padding: 1rem;">
                                    <img id="referencePreviewImg" src="{{ $eventData['reference_image'] ?? '' }}" alt="Vista Previa de Referencia" style="max-height: 280px; width: auto; max-width: 100%; object-fit: contain; margin: 0 auto; display: block; border-radius: 8px;">
                    ...
                    <div class="settings-card-box">
                        <div class="settings-card-header">
                            ...
                            <div>
                                ...
                                <p class="card-header-subtitle">Guarda las modificaciones y actualiza el evento en el sistema</p>
                            </div>
                        </div>
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        ...
                        text: data.message || 'Los cambios y aforos del evento se guardaron exitosamente.',
                        icon: 'success',
                        background: '#14141E',
                        color: '#FFFFFF'
                    }).then(() => {
