        ...
        <aside class="dash-sidebar" id="dashSidebar">
            <div class="dash-sidebar-header">
                <a href="{{ route('web.home') }}" class="dash-brand-logo">
                    <img src="{{ asset('images/logo-white.png') }}" alt="Vive Go" class="dash-logo-img logo-white-img">
                    <img src="{{ asset('images/logo.png') }}" alt="Vive Go" class="dash-logo-img logo-dark-img">
                </a>
                <button class="dash-sidebar-toggle-btn" id="dashSidebarToggle" aria-label="Colapsar Menú"
                    title="Plegar / Expandir Menú">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Toggle Sidebar con súper animación Pro Max
            ...
            if (toggleBtn && sidebar) {
                toggleBtn.addEventListener('click', function () {
                    ...
                    setTimeout(function () {
                        sidebar.classList.remove('dash-animating');
                    }, 450);
                });
            }
