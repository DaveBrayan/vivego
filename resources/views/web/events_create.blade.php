                                ...
                                <div id="template2ExtraFields" style="display: none; margin-top: 1.5rem; padding-top: 1.25rem; border-top: 1px dashed rgba(255,255,255,0.15);">
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                                        ...
                                        <div style="background: rgba(15,23,42,0.6); border: 1.5px solid rgba(255,255,255,0.12); border-radius: 16px; padding: 1.25rem;">
                                            ...
                                            <div id="bgPlaceholderBox" style="border: 1.5px dashed rgba(255,255,255,0.15); background: rgba(0,0,0,0.4); border-radius: 12px; padding: 1.5rem 1rem; text-align: center; cursor: pointer;" onclick="openMediaManager('background_image');">
                                            ...
                                            <div id="bgPreviewContainer" style="display: none; position: relative; border-radius: 12px; overflow: hidden; border: 1.5px solid rgba(255,255,255,0.2); background: #000; text-align: center; padding: 0.75rem;">
                                                <img id="bgPreviewImg" src="" alt="Fondo" style="max-height: 160px; width: 100%; object-fit: cover; border-radius: 8px;">
                                        ...
                                        <div style="background: rgba(15,23,42,0.6); border: 1.5px solid rgba(255,255,255,0.12); border-radius: 16px; padding: 1.25rem;">
                                            ...
                                            <div id="artistPlaceholderBox" style="border: 1.5px dashed rgba(255,255,255,0.15); background: rgba(0,0,0,0.4); border-radius: 12px; padding: 1.5rem 1rem; text-align: center; cursor: pointer;" onclick="openMediaManager('artist_image');">
                                            ...
                                            <div id="artistPreviewContainer" style="display: none; position: relative; border-radius: 12px; overflow: hidden; border: 1.5px solid rgba(255,255,255,0.2); background: #000; text-align: center; padding: 0.75rem;">
                                                <img id="artistPreviewImg" src="" alt="Artista" style="max-height: 160px; width: auto; max-width: 100%; object-fit: contain; border-radius: 8px;">
                                                <div style="display: flex; justify-content: center; gap: 0.5rem; margin-top: 0.65rem;">
