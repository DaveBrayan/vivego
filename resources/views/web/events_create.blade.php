                                            ...
                                            <div style="background: rgba(15,23,42,0.8); border: 1.5px dashed rgba(255,85,0,0.4); border-radius: 12px; padding: 1rem 1.25rem;">
                                                ...
                                                <div class="zone-presale-inputs-grid" style="display: grid; grid-template-columns: 1.3fr 1.35fr 1.4fr 1.4fr 1.2fr; gap: 0.85rem; opacity: 0.4; pointer-events: none;">
                                                    ...
                                                    <div style="min-width: 0;">
                                                        ...
                                                        <input type="number" step="0.50" class="form-input-custom zone-presale-price" value="120.00" min="0" style="font-size: 0.85rem; padding: 0.45rem 0.4rem; text-align: center; color: #38BDF8; font-weight: 800; width: 100%; box-sizing: border-box;" oninput="updateZonePresaleCalc(this, 'price')">
                                                    </div>
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">FECHA INICIO</label>
                                                        <input type="date" class="form-input-custom zone-presale-start" value="{{ date('Y-m-d') }}" style="font-size: 0.825rem; padding: 0.45rem 0.5rem; width: 100%; box-sizing: border-box;">
                                                    </div>
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">FECHA FIN (LÍMITE)</label>
                                                        <input type="date" class="form-input-custom zone-presale-end" value="{{ date('Y-m-d', strtotime('+15 days')) }}" style="font-size: 0.825rem; padding: 0.45rem 0.5rem; width: 100%; box-sizing: border-box;">
                                                    </div>
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">STOCK PREVENTA</label>
                                                        <input type="number" class="form-input-custom zone-presale-stock" value="200" min="0" style="font-size: 0.825rem; padding: 0.45rem 0.5rem; width: 100%; box-sizing: border-box;" placeholder="Hasta agotar">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td colspan="6" style="padding: 0.85rem 1.25rem; border-bottom: 1.5px solid rgba(255,85,0,0.25);">
                                            <div style="background: rgba(15,23,42,0.8); border: 1.5px dashed rgba(255,85,0,0.4); border-radius: 12px; padding: 1rem 1.25rem;">
                                                ...
                                                <div class="zone-presale-inputs-grid" style="display: grid; grid-template-columns: 1.3fr 1.35fr 1.4fr 1.4fr 1.2fr; gap: 0.85rem; opacity: 0.4; pointer-events: none;">
                                                    ...
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">PRECIO PREVENTA (S/)</label>
                                                        <input type="number" step="0.50" class="form-input-custom zone-presale-price" value="48.00" min="0" style="font-size: 0.85rem; padding: 0.45rem 0.4rem; text-align: center; color: #38BDF8; font-weight: 800; width: 100%; box-sizing: border-box;" oninput="updateZonePresaleCalc(this, 'price')">
                                                    </div>
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">FECHA INICIO</label>
                                                        <input type="date" class="form-input-custom zone-presale-start" value="{{ date('Y-m-d') }}" style="font-size: 0.825rem; padding: 0.45rem 0.5rem; width: 100%; box-sizing: border-box;">
                                                    ...
                                                    <div style="min-width: 0;">
                                                        <label style="font-size: 0.725rem; color: #CBD5E1; font-weight: 700; display: block; margin-bottom: 0.25rem;">STOCK PREVENTA</label>
                                                        <input type="number" class="form-input-custom zone-presale-stock" value="500" min="1" style="font-size: 0.825rem; padding: 0.45rem 0.5rem; width: 100%; box-sizing: border-box;" placeholder="Hasta agotar">
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <div style="background: rgba(16, 185, 129, 0.06); border: 1.5px solid rgba(16, 185, 129, 0.25); border-radius: 12px; padding: 0.75rem 1.15rem; margin-bottom: 1.25rem; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.85rem;">
                                ...
                                <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
                                    <label style="display: inline-flex; align-items: center; gap: 0.45rem; cursor: pointer; margin: 0;">
                                        <input type="checkbox" id="courtesy_for_admins" class="orange-checkbox" checked>
                                    ...
                                    <label style="display: inline-flex; align-items: center; gap: 0.45rem; cursor: pointer; margin: 0;" id="courtesyForUsersWrapper">
                                        <input type="checkbox" id="courtesy_for_users" class="orange-checkbox" checked>
                                    ...
                                    <div style="display: flex; align-items: center; gap: 0.4rem;">
                                        ...
                                        <input type="text" id="courtesy_ticket_name" class="form-input-custom" value="Entrada de Cortesía (Free)" placeholder="Pase de Cortesía" style="font-size: 0.8rem; padding: 0.35rem 0.6rem; width: 170px;">
                                    </div>
                                    <div style="display: flex; align-items: center; gap: 0.4rem;" id="courtesyUserMaxWrapper">
                                        ...
                                        <input type="number" id="courtesy_user_max" class="form-input-custom" value="2" min="1" max="100" style="font-size: 0.8rem; padding: 0.35rem 0.6rem; width: 65px; text-align: center;">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        <div style="display: flex; align-items: center; gap: 0.65rem; flex-wrap: wrap;">
                                            ...
                                            <span id="aforoSplitBadge" style="display: none; background: rgba(56, 189, 248, 0.18); border: 1px solid rgba(56, 189, 248, 0.4); color: #38BDF8; font-size: 0.7rem; font-weight: 800; padding: 0.15rem 0.55rem; border-radius: 6px;">
                                                ⚖️ DIVISIÓN FÍSICO / DIGITAL ACTIVA
                                            </span>
                                        </div>
                                        ...
                                        <!-- DESGLOSE EN TIEMPO REAL CUANDO DIVISIÓN FÍSICA/DIGITAL ESTÁ ACTIVADO -->
                                        <div id="aforoSplitBreakdown" style="display: none; margin-top: 0.65rem; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                                            <div style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(255, 85, 0, 0.15); border: 1px solid rgba(255, 85, 0, 0.35); padding: 0.28rem 0.65rem; border-radius: 8px;">
                                                <span style="font-size: 0.85rem;">🎟️</span>
                                                <span style="font-size: 0.78rem; color: #FDBA74; font-weight: 700;">Venta Física:</span>
                                                <strong id="aforoSplitPhysCount" style="color: #FFFFFF; font-size: 0.88rem; font-weight: 900;">0</strong>
                                                <span style="font-size: 0.72rem; color: #94A3B8;">tickets</span>
                                            </div>
                                            <div style="display: inline-flex; align-items: center; gap: 0.4rem; background: rgba(56, 189, 248, 0.15); border: 1px solid rgba(56, 189, 248, 0.35); padding: 0.28rem 0.65rem; border-radius: 8px;">
                                                <span style="font-size: 0.85rem;">💻</span>
                                                <span style="font-size: 0.78rem; color: #7DD3FC; font-weight: 700;">Venta Digital:</span>
...
@push('scripts')
    ...
    <script>
        ...
        const savedQuotaZones = [];
        const savedCourtesyZones = [];
        ...
        function applySalesTypeToQuotaInputs() {
            ...
            const thPhys = document.getElementById('thColPhys');
            const thVirt = document.getElementById('thColVirt');
            const thCortPhys = document.getElementById('thColCortPhys');
            const thCortVirt = document.getElementById('thColCortVirt');
            ...
            if (badgeEl) {
                if (salesType === 'ambos') {
                    ...
                    badgeEl.innerHTML = '🎫🌐 Venta Híbrida (Físico y Digital Activos)';
        ...
        function submitMainEventForm() {
            ...
            zones.forEach(z => {
                const matchSplit = quotaSplitZones.find(s => s.name === z.name);
                if (matchSplit) {
                    z.physical_capacity = matchSplit.physical;
                    z.virtual_capacity = matchSplit.virtual;
                    z.courtesy_physical = matchSplit.courtesy_physical;
                    z.courtesy_virtual = matchSplit.courtesy_virtual;
                }
            });
